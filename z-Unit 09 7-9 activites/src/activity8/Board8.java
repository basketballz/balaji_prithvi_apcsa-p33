...
public abstract class Board8 {
	 ...
	 *                    the deck
	 */
	public Board8(int size, String[] ranks, String[] suits, int[] pointValues) {
		cards = new Card8[size];
		deck = new Deck8(ranks, suits, pointValues);
		if (I_AM_DEBUGGING) {
